            ...
            <div class="col-lg-10 col-12">
                <div class="card shadow mb-4">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="<?= BASE_URL ?>/member/create" method="post" enctype="multipart/form-data">
                            <div class="form-row my-2">
                                <div class="col-12 col-lg-6 col-xl-8">
                                    ...
                                    <small class="form-text mt-1 mb-0 text-muted">Minimum Dimension 50x50 px.</small>
                                </div>
                            </div>
                            <div class="form-row my-2">
                                <div class="col-12 col-lg-6 col-xl-8">
                                    <label for="id">ID</label>
                                    <input type="text" class="form-control" name="id" id="id" value="<?= $data['last_id']; ?>" disabled>
                                </div>
                            </div>
                            <div class="form-row my-2">
                                <div class="col-12 col-lg-6 col-xl-8">
